...
\begin{enumerate} 
\item Write a script to integrate  orbits with an Euler method. 
\item Write a script to integrate  orbits with a Crank-Nicolson method. 
\item Write a script to integrate  orbits with a Runge--Kutta fourth order.
...
\item Integrate an orbit with these latter schemes and explain the results.
...
\item {\bf Milestone 4 : Linear problems. Regions of absolute stability.}  
  \begin{enumerate}
\item  Integrate a linear problem with some initial conditions.  
...
%******************************************************
\item {\bf Milestone 5 : circular restricted three body 
    problem.}    

 \begin{enumerate} 
    
     \item Write a function to integrate the  problem.  
...
\item {\bf Milestone 7 : Orbits of the circular restricted three body 
 ...
 \begin{enumerate} 
     ...
     \item Use antigravity and MCP to communicate with GMAT.
